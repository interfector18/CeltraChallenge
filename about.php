    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <form method="post" action="logout.php" class="form-inline my-2 my-lg-0">
                    <?php if(isset($_SESSION['id'])){echo "<p style='margin: 0px 10px 0px 0px; color:#fff; font-size: 13px;'>Welcome, $username_login.</p>;<input class='btn btn-primary' style='font-size: 15px; padding:8px 10px 7px 10px;' type='submit' name='submit' value='Logout'>";}?>
                </form>
            </div>
        </div>
    </nav>
      ...
      <div class="container">
        <div style="float:left; ">
          ...
          <p class="lead" style="width:auto; padding: 20px; font-weight:1; border-radius: 10px; background: linear-gradient(rgba(255,255, 255, 0.40), rgba(255, 255, 255, 0.0)); ">This project was made by Denis Zornada and Jasmin Makaj for participation within Celtra November Challenge.<br>
            ...
            The main motivation for creating this project was learning new technologies and this is where the <br>
            challenge came in just at the right moment. The main thing we learned is that git version control system is <br>
            a literal life saver, and has saved us from starting over again many time, in addition to making it really<br>
